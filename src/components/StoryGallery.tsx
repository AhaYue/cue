...
const StoryGallery = ({
  ...
  return (
    <section className="story-gallery py-32 overflow-hidden">
      <div className="container">
        <div className="mb-8 flex flex-col justify-between md:mb-14 md:flex-row md:items-end lg:mb-16">
          <div>
            <h2 className="mb-3 text-3xl font-semibold md:mb-4 md:text-4xl lg:mb-6  lg:text-5xl">
              {heading}
            </h2>
            <a
              href={demoUrl}
      ...
      <div className="mt-8 flex shrink-0 items-center justify-end gap-2 md:hidden">
            <Button
              size="icon"
              variant="outline"
              onClick={() => {
